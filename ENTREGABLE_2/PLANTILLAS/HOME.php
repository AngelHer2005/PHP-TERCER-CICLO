...
<head>
    ...
    <title>HOTEL DE CANES</title>
    <link rel="stylesheet" href="../style.css">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css">
</head>
<body>        
    <header>
		<a href="#" class="logo text-center">HOTEL DE CANES</a>
        <nav>
            <ul>
    ...
    <div class="Inicio" id="Inicio">
        ...
        <div class="Bienvenido">
            ...
            <span>HOTEL DE CANES</span>
            <p>¡Tu mascota merece lo mejor! <br>En nuestro HOTEL DE CANES cuidamos de ellos con cariño y profesionalismo. ¡Haz tu reserva ahora!</p>
